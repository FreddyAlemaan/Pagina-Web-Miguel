...
function Footer({ whatsappHref }) {
  return (
    <footer id="contacto" className="bg-bp-text-dark text-bp-cream px-5" style={{ paddingTop: 36, paddingBottom: 28 }}>
      <div className="max-w-5xl mx-auto">

        {/* Fila principal: marca + redes + CTA */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8 pb-5"
          ...
          <motion.a
            ...
            className="inline-block bg-bp-yellow-main text-bp-text-dark font-body font-medium text-sm px-6 py-2.5 rounded-full"
          >
            Hacer tu pedido ahora
          </motion.a>
        </div>
